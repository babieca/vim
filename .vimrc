...
" For indents that consist of a single actual tab character that appears 4-spaces-wide:
set tabstop=4 softtabstop=0 noexpandtab shiftwidth=4
" For indents that consist of 4 space characters:
" set tabstop=8 softtabstop=0 expandtab shiftwidth=4 smarttab

" See tab and white spaces at the end of the lines
...
call NERDTreeHighlightFile('a', 'blue', 'none', '#3366FF', '#151515')
call NERDTreeHighlightFile('o', 'cyan', 'none', 'cyan', '#151515')
